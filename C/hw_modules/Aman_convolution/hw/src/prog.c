...
#define my_read_write_fn(s) ({\
	uint8_t x = read_uint8(s);\
	write_uint8(s,x);\
	x;\
})
...
#define __get4xi16__(element) ({\
	element = my_read_write_fn("maxpool_input_pipe");\
	element = (element << 8) + my_read_write_fn("maxpool_input_pipe");\
	element = (element << 8) + my_read_write_fn("maxpool_input_pipe");\
	element = (element << 8) + my_read_write_fn("maxpool_input_pipe");\
	element = (element << 8) + my_read_write_fn("maxpool_input_pipe");\
	element = (element << 8) + my_read_write_fn("maxpool_input_pipe");\
...
{
	int i;
	uint16_t rt = my_read_write_fn("maxpool_input_pipe");
	rt = ( rt<<8 ) + my_read_write_fn("maxpool_input_pipe");
	uint16_t ct = my_read_write_fn("maxpool_input_pipe");
	ct = ( ct<<8 ) + my_read_write_fn("maxpool_input_pipe");
	uint16_t chl_in = my_read_write_fn("maxpool_input_pipe");
	chl_in = ( chl_in<<8 ) + my_read_write_fn("maxpool_input_pipe");
	uint16_t rb = my_read_write_fn("maxpool_input_pipe");
	rb = ( rb<<8 ) + my_read_write_fn("maxpool_input_pipe");
	uint16_t cb = my_read_write_fn("maxpool_input_pipe");
	cb = ( cb<<8 ) + my_read_write_fn("maxpool_input_pipe");
	uint16_t chl_out = my_read_write_fn("maxpool_input_pipe");
	chl_out = ( chl_out<<8 ) + my_read_write_fn("maxpool_input_pipe");
	uint16_t rk = my_read_write_fn("maxpool_input_pipe");
	rk = ( rk<<8 ) + my_read_write_fn("maxpool_input_pipe");
	uint16_t ck = my_read_write_fn("maxpool_input_pipe");
	ck = ( ck<<8 ) + my_read_write_fn("maxpool_input_pipe");
