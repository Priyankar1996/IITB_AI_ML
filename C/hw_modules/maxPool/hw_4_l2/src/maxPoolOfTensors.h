...
void __aa_barrier__();
uint64_t maxPool4(uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4);
#else
	#define __loop_pipeline_var__ {;}
	#define __aa_barrier__() {;}
	#define maxPool4(a1, a2, a3, a4) ({0;})
#endif
...
#define __maxPoolOfTensors3D_div__(src, dst, rs, cs, re, ce, dim1d, dim1, offset1, offset2) ({\
	...
	{\
		...
		dst.data_array[address] = maxPool4(add_src,add_src+offset1,add_src+offset2,add_src+offset3);\
