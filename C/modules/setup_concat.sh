...
# gcc -o obj/tb_utils.o -c -g -std=c99 src/tb_utils.c -I include/  -lm 

gcc -o obj/test_concat.o -c -g -std=c99 util/concat_tb.c -I include/ -I ../mempool/include/ -I ../primitives/include/ -I src/
gcc -o bin/test_concat obj/concat.o obj/test_concat.o obj/createTensor.o obj/mempool.o obj/tensor.o obj/readWriteTensors.o -lm #obj/tb_utils.o
