...
gcc -o obj/unary_fn.o -c -g src/unary_fn.c -I include/ -I ..//mempool/include/ -I ../primitives/include/
gcc -o obj/Test_unary_fn.o -c -g util/Test_unary_fn.c -I include/ -I ..//mempool/include/ -I ../primitives/include/
gcc -o bin/Test_unary_fn obj/Test_unary_fn.o obj/mempool.o obj/tensor.o obj/createTensor.o obj/unary_fn.o  
