...
gcc -o obj/unary_inplace_fn.o -c -g -std=c99 src/unary_inplace_fn.c -I include/ -I ..//mempool/include/ -I ../primitives/include/ -lm
...
gcc -o bin/Test_unary_inplace_fn obj/Test_unary_fn.o obj/mempool.o obj/tensor.o obj/createTensor.o obj/unary_fn.o -lm
