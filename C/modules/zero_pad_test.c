...
int main(){
	...
	_err1_ = readTensorFromFile("./util/a.csv",&a,&pool);
    ...
    b.descriptor.dimensions[2] = a.descriptor.dimensions[2];
    for (int i=0;i<a.descriptor.number_of_dimensions -1 ;i++)
    {
	...
	_err1_ += writeTensorToFile("./util/b.csv", &b);
    if(_err1_ != 0){
