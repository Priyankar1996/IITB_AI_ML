...
void convolutionAll (uint16_t rb, uint16_t cb, uint16_t rt, uint16_t ct, uint16_t chl_out, uint16_t chl_in, uint16_t rk, uint16_t ck, uint8_t index_in1, uint8_t index_in2, uint8_t index_k, uint8_t index_out, uint16_t shift_val,uint16_t pad,  uint8_t activation);
...
void systemTOP()
{
	...
	// 0 -> 1
	convolutionAll(224,224,224,224,64,3,3,3,0,0,0,1,0,1,relu);
	write_uint8("debug_output_pipe",11);
	__aa_barrier__();
	// 1 -> 2
	convolutionAll(224,224,224,224,64,64,3,3,1,0,1,2,0,1,relu);
	write_uint8("debug_output_pipe",12);
	__aa_barrier__();
	// 2 -> 1
	convolutionAll(112,112,112,112,128,64,3,3,2,0,2,1,0,1,relu);
	write_uint8("debug_output_pipe",13);
	__aa_barrier__();
	// 1 -> 3
	convolutionAll(112,112,112,112,128,128,3,3,1,0,3,3,0,1,relu);
	write_uint8("debug_output_pipe",14);
	__aa_barrier__();
	// 3 -> 1
	convolutionAll(56,56,56,56,256,128,3,3,0,0,4,1,0,1,relu);
	write_uint8("debug_output_pipe",15);
	__aa_barrier__();
	// 1 -> 4
	convolutionAll(56,56,56,56,256,256,3,3,1,0,5,4,0,1,relu);
	write_uint8("debug_output_pipe",16);
	__aa_barrier__();
	
	// 4 -> 1
	convolutionAll(28,28,28,28,512,256,3,3,4,0,6,1,0,1,relu);
	write_uint8("debug_output_pipe",17);
	__aa_barrier__();
	// 1 -> 0
	convolutionAll(28,28,28,28,512,512,3,3,1,0,7,0,0,1,relu);
	...
	__aa_barrier__();
	// 1 -> 0
	convolutionAll(56,56,28,28,256,512,2,2,0,0,8,1,0,0,relu);
	...
	__aa_barrier__();
	// 1 -> 0
	convolutionAll(56,56,56,56,256,512,3,3,4,129,9,0,0,1,relu);
	write_uint8("debug_output_pipe",22);
	__aa_barrier__();
	// 0 -> 1
	convolutionAll(56,56,56,56,256,256,3,3,0,0,10,1,0,1,relu);
	...
	__aa_barrier__();
	// 1 -> 0
	convolutionAll(112,112,56,56,128,256,2,2,1,0,11,0,0,0,relu);
	...
	__aa_barrier__();
	// 3,0 -> 1
	convolutionAll(112,112,112,112,128,256,3,3,3,128,12,1,0,1,relu);
	write_uint8("debug_output_pipe",27);
	__aa_barrier__();
	// 1 -> 0
	convolutionAll(112,112,112,112,128,128,3,3,1,0,13,0,0,1,relu);
	...
	__aa_barrier__();
	// 1 -> 0
	convolutionAll(224,224,112,112,64,128,2,2,0,0,14,1,0,0,relu);
	...
	__aa_barrier__();
	// 1 -> 0
	convolutionAll(224,224,224,224,64,128,3,3,2,129,15,0,0,1,relu);
	write_uint8("debug_output_pipe",32);
	__aa_barrier__();
	// 0 -> 1
	convolutionAll(224,224,224,224,64,64,3,3,0,0,16,1,0,1,relu);
	write_uint8("debug_output_pipe",33);
	__aa_barrier__();

	// 1 -> 0
	//Final stage is a sigmoid activation	  
	convolutionAll(224,224,224,224,3,64,3,3,1,0,17,0,0,1,sigmoid);
