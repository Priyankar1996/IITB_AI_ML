...
void systemTOP()
{
	...
	uint16_t rt = read_uint8 ("system_input_pipe");
	rt = ( rt<<8 ) + read_uint8 ("system_input_pipe");
	uint16_t rb = read_uint8 ("system_input_pipe");
	rb = ( rb<<8 ) + read_uint8 ("system_input_pipe");
	uint16_t ct = read_uint8 ("system_input_pipe");
	ct = ( ct<<8 ) + read_uint8 ("system_input_pipe");
	uint16_t cb = read_uint8 ("system_input_pipe");
	cb = ( cb<<8 ) + read_uint8 ("system_input_pipe");
	uint16_t chl_in = read_uint8 ("system_input_pipe");
	chl_in = ( chl_in<<8 ) + read_uint8 ("system_input_pipe");
	uint16_t chl_out = read_uint8 ("system_input_pipe");
	chl_out = ( chl_out<<8 ) + read_uint8 ("system_input_pipe");
	...
	for (i = 0; i < (size>>3); i++)
	{
		...
		//write_uint8 ("system_output_pipe",240);
	}
	__aa_barrier__();
	...
	__aa_barrier__();
	//write_uint8 ("system_output_pipe",251);
	...
	//write_uint8 ("system_output_pipe",250);
	sendOutput(rb*cb*chl_out);
	__aa_barrier__();
	write_uint8 ("system_output_pipe",out_data[0]);\
	write_uint8 ("system_output_pipe",out_data[1]);\
	write_uint8 ("system_output_pipe",out_data[2]);\
