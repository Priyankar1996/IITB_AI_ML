...
#
# Generated by Vivado on Wed Feb 01 16:20:31 IST 2023
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../clocking_wizard_120MHz.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../clocking_wizard_120MHz.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/aiml/IITB_AI_ML/VCU/UNET/ip/clocking_wizard_120MHz/clocking_wizard_120MHz.cache/compile_simlib/vcs"
  fi
