...
{
char buffer[4096];  char* ss;  sprintf(buffer, "call accessAcceleratorRegisters ");
append_int(buffer,3); ADD_SPACE__(buffer);
append_uint8_t(buffer,write_bar); ADD_SPACE__(buffer);
append_uint32_t(buffer,reg_index); ADD_SPACE__(buffer);
append_uint32_t(buffer,reg_value); ADD_SPACE__(buffer);
append_int(buffer,1); ADD_SPACE__(buffer);
append_int(buffer,32); ADD_SPACE__(buffer);
send_packet_and_wait_for_response(buffer,strlen(buffer)+1,"localhost",9999);
...
append_uint16_t(buffer,ck); ADD_SPACE__(buffer);
append_uint32_t(buffer,base_address_in1); ADD_SPACE__(buffer);
append_uint32_t(buffer,base_address_in2); ADD_SPACE__(buffer);
append_uint32_t(buffer,base_address_k); ADD_SPACE__(buffer);
append_uint32_t(buffer,base_address_out); ADD_SPACE__(buffer);
...
void execute_layer()
{
char buffer[4096];  char* ss;  sprintf(buffer, "call execute_layer ");
append_int(buffer,0); ADD_SPACE__(buffer);
append_int(buffer,0); ADD_SPACE__(buffer);
send_packet_and_wait_for_response(buffer,strlen(buffer)+1,"localhost",9999);
return;
...
append_uint32_t(buffer,base_address); ADD_SPACE__(buffer);
append_int(buffer,0); ADD_SPACE__(buffer);
send_packet_and_wait_for_response(buffer,strlen(buffer)+1,"localhost",9999);
return;
}
...
append_uint16_t(buffer,pad); ADD_SPACE__(buffer);
append_uint8_t(buffer,num_parts); ADD_SPACE__(buffer);
append_uint32_t(buffer,base_address1); ADD_SPACE__(buffer);
append_uint32_t(buffer,base_address2); ADD_SPACE__(buffer);
append_int(buffer,0); ADD_SPACE__(buffer);
send_packet_and_wait_for_response(buffer,strlen(buffer)+1,"localhost",9999);
return;
}
...
{
char buffer[4096];  char* ss;  sprintf(buffer, "call interrupt_daemon ");
append_int(buffer,0); ADD_SPACE__(buffer);
append_int(buffer,0); ADD_SPACE__(buffer);
send_packet_and_wait_for_response(buffer,strlen(buffer)+1,"localhost",9999);
return;
...
{
char buffer[4096];  char* ss;  sprintf(buffer, "call set_convolution_layer ");
append_int(buffer,16); ADD_SPACE__(buffer);
append_uint16_t(buffer,rb); ADD_SPACE__(buffer);
append_uint16_t(buffer,cb); ADD_SPACE__(buffer);
append_uint16_t(buffer,rt); ADD_SPACE__(buffer);
...
append_uint16_t(buffer,rk); ADD_SPACE__(buffer);
append_uint16_t(buffer,ck); ADD_SPACE__(buffer);
append_uint32_t(buffer,addr_in1); ADD_SPACE__(buffer);
append_uint32_t(buffer,addr_in2); ADD_SPACE__(buffer);
append_uint32_t(buffer,addr_k); ADD_SPACE__(buffer);
append_uint8_t(buffer,addr_out); ADD_SPACE__(buffer);
append_uint16_t(buffer,shift_val); ADD_SPACE__(buffer);
append_uint16_t(buffer,pad); ADD_SPACE__(buffer);
append_uint8_t(buffer,pool); ADD_SPACE__(buffer);
append_uint8_t(buffer,activation); ADD_SPACE__(buffer);
...
{
char buffer[4096];  char* ss;  sprintf(buffer, "call tester_control_daemon ");
append_int(buffer,0); ADD_SPACE__(buffer);
append_int(buffer,0); ADD_SPACE__(buffer);
send_packet_and_wait_for_response(buffer,strlen(buffer)+1,"localhost",9999);
return;
