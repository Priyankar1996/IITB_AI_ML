...
\bigskip
\textbf{An AI/ML Inference Engine Developed Using AHIR-V2 Tools For Use In AJIT Processor Based Systems-on-Chip}\\
\bigskip
...
\textbf{Bachelor Of Technology + Master of Technology in Electrical Engineering}\\
...
Using Equation~\ref{eq:conv}, the algorithm for convolution is described in Algorithm~\ref{Algo:cov}.
