...
void systemTOP()
{
	...
	// 0 -> 1
	zeropad(224,224,3,226,226,30,0,1);
    // 1 -> 0
    convolution3D(224,224,64,3,1,0,0,226,relu);
    // 0 -> 1
    zeropad(224,224,64,226,226,64,0,1);
    // 1 -> 2
    convolution3D(224,224,64,64,1,1,2,226,relu);
    // 2 -> 0
    maxPool3D(112,112,224,64,2,0);
    // 0 -> 1
    zeropad(112,112,64,114,114,64,0,1);
    // 1 -> 0
    convolution3D(112,112,128,64,1,2,0,114,relu);
    // 0 -> 1
    zeropad(112,112,128,114,114,128,0,1);
    // 1 -> 3
    convolution3D(112,112,128,128,1,3,3,114,relu);
    // 3 -> 0
    maxPool3D(56,56,112,128,3,0);
    // 0 -> 1
    zeropad(56,56,112,58,58,112,0,1);
    // 1 -> 0
    convolution3D(56,56,256,128,1,4,0,58,relu);
    // 0 -> 1
    zeropad(56,56,256,58,58,256,0,1);
    // 1 -> 4
    convolution3D(56,56,256,256,1,5,4,58,relu);
    // 4 -> 0
    ...
    // 1 -> 0
    convolution3D(28,28,512,256,1,6,0,30,relu);
    // 0 -> 1
    zeropad(28,28,512,30,30,512,0,1);
    // 1 -> 0
    convolution3D(28,28,512,512,1,7,0,30,relu);


    // 0 -> 1
    convTranspose(28,28,512,2,2,2,0,57,57,512,0,1);
    // 1 -> 0
    convolution3D(56,56,256,512,1,8,0,58,relu);
    // 4,0 -> 1
    concat(56,56,256,56,56,256,56,56,512,4,0,1);
    // 1 -> 0
    zeropad(56,56,512,58,58,512,1,0);
    // 0 -> 1
    convolution3D(56,56,256,512,0,9,1,58,relu);
    // 1 -> 0
    zeropad(56,56,256,58,58,256,1,0);
    // 0 -> 1
    convolution3D(56,56,256,256,0,10,1,58,relu);
    
    // 1 -> 0
    convTranspose(56,56,256,2,2,2,0,113,113,256,1,0);
    // 0 -> 1
    convolution3D(112,112,128,256,0,11,1,114,relu);
    // 3,1 -> 0
    concat(112,112,128,112,112,128,112,112,256,3,1,0);
    // 0 -> 1
    zeropad(112,112,256,114,114,256,0,1);
    // 1 -> 0
    convolution3D(112,112,128,256,1,12,0,114,relu);
    // 0 -> 1
    zeropad(112,112,128,114,114,128,0,1);
    // 1 -> 0
    convolution3D(112,112,128,128,1,13,0,114,relu);

    // 0 -> 1
    convTranspose(112,112,256,2,2,2,0,225,225,256,0,1);
    // 1 -> 0
    convolution3D(224,224,64,128,1,14,0,226,relu);
    // 2,0 -> 1
    concat(224,224,64,224,224,64,224,224,128,2,0,1);
    // 1 -> 0
    zeropad(224,224,128,226,226,128,1,0);
    // 0 -> 1
    convolution3D(224,224,64,128,0,15,1,226,relu);
    // 1 -> 0
    zeropad(224,224,64,226,226,64,1,0);
    // 0 -> 1
    convolution3D(224,224,64,64,0,16,1,226,relu);

    // 1 -> 0
    zeropad(224,224,64,226,226,64,1,0);
    // 0 -> 1
    convolution3D(224,224,3,64,0,17,1,226,sigmoid);
