...
int main(){
	...
	//define tensor
	const TensorDataType dataType = i64;
	...
	a.descriptor.dimensions[0] = 5;  // Also simply tried 4
	a.descriptor.dimensions[1] = 5;  // Also simply tried 4
	a.descriptor.dimensions[2] = 3;  // Also simply tried 1
	...
	b.descriptor.dimensions[2] = 2; // Also simply tried 1
	...
	*/
    ...
    int strides[3] = {2, 2, 1}; //non zero also simply tried {1, 1, 1}
    int padding[6] = {1, 1, 1, 1, 1, 0}; // Also simply tried all 0
