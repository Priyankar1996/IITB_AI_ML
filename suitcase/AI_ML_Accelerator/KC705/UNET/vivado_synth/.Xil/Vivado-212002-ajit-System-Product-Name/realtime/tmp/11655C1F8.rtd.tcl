...
set genomeRtd $env(RT_TMP)/11655C1F8.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is base_bank_dual_port_for_xst__parameterized37__GB13"
...
set genomeName base_bank_dual_port_for_xst__parameterized37__GB13
