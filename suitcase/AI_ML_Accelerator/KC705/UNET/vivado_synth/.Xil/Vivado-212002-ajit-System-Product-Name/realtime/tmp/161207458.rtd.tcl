...
set genomeRtd $env(RT_TMP)/161207458.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is base_bank_dual_port_for_xst__parameterized53__GB7"
...
set genomeName base_bank_dual_port_for_xst__parameterized53__GB7
