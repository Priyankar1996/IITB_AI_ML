...
set genomeRtd $env(RT_TMP)/4778BCB0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is base_bank_dual_port_for_xst__parameterized9__GB9"
...
set genomeName base_bank_dual_port_for_xst__parameterized9__GB9
