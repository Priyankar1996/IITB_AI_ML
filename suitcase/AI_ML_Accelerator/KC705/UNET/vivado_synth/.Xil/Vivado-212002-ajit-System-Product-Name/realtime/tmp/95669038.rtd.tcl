...
set genomeRtd $env(RT_TMP)/95669038.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is base_bank_dual_port_for_xst__parameterized43__GB5"
...
set genomeName base_bank_dual_port_for_xst__parameterized43__GB5
