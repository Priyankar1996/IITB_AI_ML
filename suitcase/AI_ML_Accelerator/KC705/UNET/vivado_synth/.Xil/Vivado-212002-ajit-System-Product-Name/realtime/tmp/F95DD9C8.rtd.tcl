...
set genomeRtd $env(RT_TMP)/F95DD9C8.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is base_bank_dual_port_for_xst__parameterized17__GB4"
...
set genomeName base_bank_dual_port_for_xst__parameterized17__GB4
